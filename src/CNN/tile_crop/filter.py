...
#src: https://github.com/CODAIT/deep-histopath/blob/master/deephistopath/wsi/filter.py
...
# plement(np_img, output_type="uint8"):
#   """
...
#Changed min size to .5% previous
  mask_remove_small = filter_remove_small_objects(mask_gray_green_pens, min_size=1, output_type="bool")
  rgb_remove_small = util.mask_rgb(rgb, mask_remove_small)
