...
def save_above_threshold(slide_num, display=True, save_summary=False, save_data=True, save_top_tiles=True, threshold = 0):
  """
  Generate tile summary and top tiles for slide.
...
def image_list_to_tiles_threshold(image_num_list, display=False, save_summary=True, save_data=True, save_top_tiles=True, threshold = 0):
  """
  Generate tile summaries and tiles for a list of images.
  ...
  tile_summaries_dict = dict()
  for slide_num in image_num_list:
    tile_summary = save_above_threshold(slide_num, display, save_summary, save_data, save_top_tiles, threshold)
    tile_summaries_dict[slide_num] = tile_summary
  return image_num_list, tile_summaries_dict


def image_range_to_tiles_threshold(start_ind, end_ind, display=False, save_summary=True, save_data=True, save_top_tiles=True, threshold = 0):
  """
...
def singleprocess_filtered_images_to_tiles_2(display=False, save_summary=True, save_data=True, save_top_tiles=True,
                                           html=True, image_num_list=None):
  """
  Generate tile summaries and tiles for training images using a single process.
