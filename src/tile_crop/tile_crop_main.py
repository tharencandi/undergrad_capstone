...
def single_image_to_folder_of_tiles(image_path = "", cell_threshold = 0, save=False, save_dir = ""):
  ...
  for item in os.listdir(SRC_TRAIN_DIR):
    if item.endswith(".png"):
          os.remove(os.path.join(SRC_TRAIN_DIR, item))
