...
# def test_return():
#     assert single_image_to_folder_of_tiles("data/training_slides/CELLCIRC-001.svs", 10, save=False, 
#     save_dir="data/test_directory_for_slides") == ["data/training_slides/CELLCIRC-001.svs",(18,16)], "Test failed"
